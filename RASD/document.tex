...
\begin{itemize}
	...
	\item Through the API:\@
		\begin{itemize}
			...
			\item Establish a Secure Channel %TODO add this to keywords
			...
			\item Using a valid login-token:\@
				\begin{itemize}
					...
					\item Logout (this will close the secure channel and invalidate the login token) %TODO add ``login token'' to keywords
				\end{itemize}
		\end{itemize}
\end{itemize}
