...
The myTaxiService application will be released as a web application and as a mobile application. 
...
\begin{itemize}
	\item Owned by the users and taxi drivers:
		\begin{itemize}
			\item Any device running Android, iOS or WindowsPhone
...
\end{figure}
\begin{figure}[H]
	  \makebox[\textwidth][c]{\includegraphics[width=1.5\textwidth]{Alloy/ACrossAreaService}}
