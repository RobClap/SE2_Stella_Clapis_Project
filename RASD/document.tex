...
\clearpage
<<<<<<< HEAD
\paragraph{Cancel a request interface}%TODO
This is the mockup of the page where a logged in user can request a taxi
\includegraphics{Request a taxi interface}
\clearpage
\paragraph{Cancel a reservation interface}%TODO
...
\clearpage
\paragraph{Modify taxi driver interface} %TODO finire i mockup con i campi
This is where an administrator can modify the information of a taxi driver
\includegraphics{}
\clearpage
\paragraph{Add taxi driver interface} %TODO finire i mockup con i campi
...
<<<<<<< HEAD
	...
	\subsubsection{Modify taxi driver}%TODO controllare campi
