...
\begin{itemize}
	\item \textit{End users:} this category comprises all those who use the application (for their definition we refer to the RASD's section %TODO inserire sezione
