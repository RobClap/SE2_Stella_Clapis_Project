...
\subsubsection{6}
The convenction is respected, but not for the variable "clh" which is a 3 letter lowercase word used as an acronym.
\subsubsection{7}
...
\begin{itemize}
	...
	\item 
\end{itemize}
%TODO erica: anche in validationmappintdescriptors chiude solo l'ultimo reader e non chiude gli inputstream % aggiungilo agli items sopra
