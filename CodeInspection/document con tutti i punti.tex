...
We were assigned the three methods registerBeanValidator, 
getValidationMappingDescriptors and event from class
ConnectorDeployer in package
...
\subsubsection{13}
%TODO e non ce n'è nessuna da segnalare che avrebbe senso splittata? Onestamente non ne ho trovate, secondo me l'hanno fatto fare a del codice
%Se vuoi guardare sono in sh/longerthan80 però ci ho già dato un'occhiata io e non mi pare.
There are 74 lines longer than 80 chars but splitting the line would just reduce readability.
\subsubsection{14}
...
%TODO ROB forse il fatto che event sia troppo lungo è da mettere qui e non in fondo tra i problemi
...
operation caused the arousal of the exception (except for the ones 
pointed out at 53) and eventually provide a stack trace, but no
...
\begin{itemize}
	...
	\item The ``event'' method is too complex, it should be split in simpler and smaller methods.
\end{itemize}
%TODO anche in validationmappintdescriptors chiude solo l'ultimo reader e non chiude gli inputstream
...
\begin{center}
	...
	\begin{tabular}{*{2}{c}}
		...
		Analyze naming conventions & sed, grep, cat, tr\\ %TODO sai che non credo dovremmo scriverli questi?
		\bottomrule
	\end{tabular}
\end{center}
\-\\
