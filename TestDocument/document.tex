...
%TODO che vuol dire relate to any product features/functions that are being built up? %Non lo so
%TODO i test delle tue immagini hanno una numerazione con la quale non sono d'accordo, e dovrebbero chiamarsi ``I'' non ``T'' e le frecce non sono al contrario? 
%TODO dato che mi sto lamentando cosi' tanto dei grafici, vuoi che li rifaccia io in dot? Ci metto due secondi e se vogliamo modificarli si fa velocemente
...
%TODO qua manca una intera sezione con le procedure di test? Va fatta?
...
%Credo che intenda i casi test, con particolare attenzione su quelli dei casi limite
\end{document}
